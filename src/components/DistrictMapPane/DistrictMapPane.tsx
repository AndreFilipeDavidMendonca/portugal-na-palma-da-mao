  ...
  return (
    <div className="district-map-pane">
      ...
      >
        ...
        <FirstZoomInTrigger
          enabled={enableFirstZoomHint}
          onFirstZoomIn={onFirstZoomIn}
        />
      </MapContainer>
    </div>
  );
